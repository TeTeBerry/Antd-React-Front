...
class Meter extends Component {
  ...
  handleUpdate = () => {
    ...
    console.log(formFields);
    const formData = {
      metername: this.formFields.metername,
      descriptions: this.formFields.descriptions,
      meterid: this.formFields.meterid,
      roomnumber: this.formFields.roomnumber,
      membercontact: this.formFields.membercontact,
      membername: this.formFields.membername
    };
