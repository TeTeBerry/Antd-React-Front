...
class RegisterForm extends Component {
    ...
    Submitform = () => {
      const isAdmin = this.props.location.search.includes('admin') ? 'Change' : 'Set';
    }
    ...
    onChangePassword = (e) => {
      ...
      render() { 
        ...
        return (
            ...
            <h1>{this.Submitform} Password</h1>
          ...
          <Button type="primary" htmlType="submit">{this.Submitform}</Button>
