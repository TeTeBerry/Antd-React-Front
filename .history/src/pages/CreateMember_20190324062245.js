...
const CollectionCreateForm = Form.create({ name: 'form_in_modal' })(
  class CreateMember extends Component {
    onChangeMembername = (e) => {
      ...
      this.props.handleCreate(this.state.membername);
    }
    ...
    onChangeTel = (e) => {
      ...
      this.props.handleCreate(this.state.tel);
    }
    ...
    onChangeRoom = (e) => {
      ...
      this.props.handleCreate(this.state.room);
    }
    ...
    onChangeEmail = (e) => {
      ...
      this.props.handleCreate(this.state.email);
    }
    ...
    onChangePassword = (e) => {
      ...
      this.props.handleCreate(this.state.password);
    }
